...
{{< include ./simple-arithmetic.md >}}
{{< include ./simple-division-normal-and-integer-division.md >}}
...
{{< include ./modified-bavarian-formula.md >}}



{{< include ./is_odd_or_even.md >}}
...
{{< include ./errors-generation-nickname.md >}}
{{< include ./errors-exception1.md >}}

{{< include ./find-area-and-circumference-of-the-circle.md >}}

{{< include ./ordinal-suffix-writing.md >}}


{{< include ./simple-random-password1.md >}}

{{< include ./find-first-digit.md >}}



{{< include ./number_to_english.md >}}
...
{{< include ./star-rhombus-1.md >}}


{{< include ./is_odd_or_even_function.md >}}

{{< include ./function-title-case.md >}}
...
{{< include ./prime-number.md >}}

{{< include ./high-light-word.md >}}
...
{{< include ./exception-handling-simple1.md >}}



{{< include ./palindrome-recursion.md >}}

{{< include ./prime-number_recursion.md >}}
